...
from llm.types import Message, Tool, TextBlock, ToolUseBlock, ToolResultBlock
...
class TestContextBudget:
    def test_defaults(self):
        assert DEFAULT_CONTEXT_BUDGET.max_context_tokens == 64_000
        assert DEFAULT_CONTEXT_BUDGET.reserved_for_response == 4096
